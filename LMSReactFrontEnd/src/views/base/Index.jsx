          ...
          <div className="row mb-5">
            ...
            <div className="col-md-6 col-lg-3 border-top-md border-top border-end-lg">
              ...
              <div className="py-7 text-center">
                ...
                {/* text */}
                <div className="lh-1">
                  <h2 className="mb-1">5.8 Million+</h2>
            ...
            <div className="col-md-6 col-lg-3 border-top-lg border-top border-end-md">
              ...
              <div className="py-7 text-center">
                ...
                {/* text */}
                <div className="lh-1">
                  <h2 className="mb-1">28,000+</h2>
                  <span>Courses in 30 languages</span>
                </div>
              </div>
            </div>
      ...
      <div className="sliderTestimonial">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="item review-card"> {/* Add the review-card class here */}
              <div className="card">
                <div className="card-body text-center p-6">
                  ...
                  <p className="mb-0 mt-3">
                    “Lorem Ipsum text is generated algorithmically, ensuring it's free from repetition, unintended humor, words.”
                  </p>
                  {/* rating */}
                  ...
                  <h3 className="mb-0 h4">George T</h3>
                  <span>Data Engineer at Amex</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="item review-card"> {/* Add the review-card class here */}
              <div className="card">
                <div className="card-body text-center p-6">
                  ...
                  <h3 className="mb-0 h4">Adam Berg</h3>
            ...
            <div className="item review-card"> {/* Add the review-card class here */}
              <div className="card">
                <div className="card-body text-center p-6">
                  ...
                  <h3 className="mb-0 h4">Ram P</h3>
                  <span>Student at IIT Hyderabad</span>
                </div>
              </div>
            </div>
          </div>
