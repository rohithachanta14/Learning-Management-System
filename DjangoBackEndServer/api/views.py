...
class StripeCheckoutAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Fake Checkout Session Created", "stripe_session_id": order.stripe_session_id},status=status.HTTP_200_OK)
...
class PaymentSuccessAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Handle notifications and course enrollment
...
class PaymentStatusAPIView(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response({"message": order.payment_status}, status=status.HTTP_200_OK)
